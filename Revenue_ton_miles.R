...
##2019
df_2019 <- read_excel(paste0(path,"Supply_Chain.xlsx"),
                      sheet = "2019",
                      skip = 1,
                      n_max = 21)
...
##2020
df_2020 <- read_excel(paste0(path,"file.xlsx"),
                      sheet = "2020",
                      skip = 2,
                      n_max = 20)
df_2020 <- df_2020[-c(2)]
...
##2021
df_2021 <- read_excel(paste0(path,"file.xlsx"),
                      sheet = "2021",
                      skip = 1,
                      n_max = 20)
...
##2022
df_2022 <- read_excel(paste(path,"file.xlsx",sep = ""),
                      sheet = "2022",
                      skip = 1,
                      n_max = 20)
...
##2023
df_2023 <- read_excel(paste(path,"file.xlsx",sep = ""),
                      sheet = "2023",
                      skip = 1,
                      n_max = 20)
...
write_csv(Collected, "Data/Revenue_ton_miles.xlsx")
